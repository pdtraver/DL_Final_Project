...
class LabelDataset(tfds.core.GeneratorBasedBuilder):
    ...
    RELEASE_NOTES = {"6.0.0" : "Unlabeled release."}
    SUPPORTED_VERSIONS = [tfds.core.Version("6.0.0")]
    ...
    def _info(self):
        ...
        self.video_paths = [os.path.join('/scratch/pdt9929/DL_Final_Project/dataset/hidden_predictions/', dir_path) for dir_path in os.listdir('/scratch/pdt9929/DL_Final_Project/dataset/hidden_predictions/') if dir_path.startswith('video')]
        self.batch_size = 2
