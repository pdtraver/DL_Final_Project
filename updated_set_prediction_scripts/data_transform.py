...
class LabelDataset(tfds.core.GeneratorBasedBuilder):
    ...
    def _info(self):
        ...
        self.video_paths = [os.path.join('/scratch/kmk9461/google-research/slot_attention/dataset/train/', dir_path) for dir_path in os.listdir('/scratch/kmk9461/google-research/slot_attention/dataset/train/') if dir_path.startswith('video')]
        self.batch_size = 2
        ...
        features = {
            ...
            "objects": tfds.features.Sequence({
                ...
                "3d_coords": tfds.features.Tensor(shape=(3,), dtype=np.float64),
...
def main():
    path = '/scratch/kmk9461/google-research/slot_attention/'
