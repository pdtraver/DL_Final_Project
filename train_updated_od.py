...
flags.DEFINE_integer("num_train_steps", 1, "")#0000, "Number of training steps.")
flags.DEFINE_integer("warmup_steps", 40,#00
...
def train_step(batch, model, optimizer):
  ...
  #capped_gvs = [(tf.clip_by_value(grad, -1., 1.)) for grad in gradients]
...
def main(argv):
  ...
  data_iterator = data_utils.build_clevr_iterator(
      ...
      max_n_objects=10, get_properties=False, apply_crop=True)
