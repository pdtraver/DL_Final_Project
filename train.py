...
def main(argv):
  ...
  data_iterator = LabelDataset('../Deep Learning/dataset/train', batch_size)
  data_iterator_validation = LabelDataset('../Deep Learning/dataset/train', batch_size)
  ...
  model.save_weights('/scratch/au2216/google-research/slot_attention/weights.ckpt')
